    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="Ex: Saude e Bem-estar"
            className="bg-zinc-950/50 border-zinc-800 text-white placeholder:text-zinc-600 focus:border-white/50 focus:ring-0 rounded-sm h-12"
            required
          />
        </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={(e) =>
            updateField("ingredientes_mecanismo", e.target.value)
          }
      ...
      <div className="space-y-2">
        ...
        <Select
          value={product.tom}
          onValueChange={(v) => updateField("tom", v)}
        >
          <SelectTrigger
            data-testid="product-tone"
            className="bg-zinc-950/50 border-zinc-800 text-white rounded-sm h-12"
          >
